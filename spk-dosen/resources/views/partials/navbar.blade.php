  ...
  <div class="container">
    ...
    @auth
      <div class="collapse navbar-collapse" id="navbar">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item pe-3">
            <a class="nav-link active" aria-current="page" href="/students">Daftar Dosen</a>
          </li>
          <li class="nav-item pe-3">
    ...
    @else
      <div class="collapse navbar-collapse justify-content-md-center" id="navbar">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active fw-bold" aria-current="page" href="/">SPK Penyeleksi Calon Dosen</a>
          </li>
        </ul>
      </div>
    @endauth
